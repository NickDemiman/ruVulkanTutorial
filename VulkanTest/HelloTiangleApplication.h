...
#pragma region Функции для создания DebugMessengger
...
class HelloTiangleApplication
{
	...
	#pragma region Функции для инициализирования окна
...
public:
	...
	#pragma region Доп функции для создания инстанса
	private:
	...
	#pragma region Семейства Очередей
	private:
